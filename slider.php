	...
	<div class='csslider1 autoplay '>
		...
		<div class='cs_bullets'>
			<label class='num0' for='cs_slide1_0'>
				...
				<span class='cs_thumb'><img src='' alt='Buns' title='' /></span>
			</label>
			<label class='num1' for='cs_slide1_1'>
				<span class='cs_point'></span>
				<span class='cs_thumb'><img src='' alt='Croissant' title='' /></span>
			</label>
			<label class='num2' for='cs_slide1_2'>
				<span class='cs_point'></span>
				<span class='cs_thumb'><img src='' alt='Lemon pie' title='' /></span>
			</label>
		</div>
		</div>
	<!-- End cssSlider.com -->
